sap.ui.define([
    ...
    return BaseController.extend("customers.customerssplit.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "customers.customerssplit.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("CodigoCliente")
            }, bReplace);
        },
