		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#customerscustomerssplit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerscustomerssplit-display": {
								"semanticObject": "customerscustomerssplit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customers.customerssplit",
									"url": sap.ui.require.toUrl("customers/customerssplit")
								}
							}
						}
					}
